...
const AdminBrandEdit = () => {
    ...
    const getDetails = async()=> {
        try{
            ...
            toast.error("brand doesnot exist")
            navigate("/admin/brand")
    ...
    <>
      <Container className="px-4" fluid>
        ...
        <Breadcrumb className="mb-4">
          ...
          <li className="breadcrumb-item active">brand form</li>
        </Breadcrumb>
        <Card className="mb-4">
          <Card.Header>
            <Container>
                                ...
                                <Col sm = {2}>
                                    {
                                        detail && detail.image 
                                        ?
                                         <img src={import.meta.env.VITE_IMAGE_URL+'/uploads/brand/'+detail.image} className="img img-fluid"/>
                                         : <></>
                                    }
                                </Col>
