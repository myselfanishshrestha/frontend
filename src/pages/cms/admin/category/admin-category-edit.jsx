...
const AdminCategoryEdit = () => {
    ...
    const getDetails = async()=> {
        try{
            let response = await categorySvc.getCategoryById(params.id)
            ...
            toast.error("category doesnot exist")
            navigate("/admin/category")
                                ...
                                <Col sm = {2}>
                                    {
                                        detail && detail.image 
                                        ?
                                         <img src={import.meta.env.VITE_IMAGE_URL+'/uploads/category/'+detail.image} className="img img-fluid"/>
                                         : <></>
                                    }
                                </Col>
